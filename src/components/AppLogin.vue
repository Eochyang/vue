                ...
                <div class="row">
                    <div class="col-md-12 tal mt20">
                        ...
                        <label class="checkbox">
                            ...
                            <div class="clear"></div>
                            <div class="col-xs-6 p0"><button type="button" class="btn btn-info btn-block" tabindex="5" @click="login">登  陆</button></div>
                            <div class="col-xs-5 p0" style="margin-left:10px;"><button type="button" class="btn btn-default btn-block" tabindex="6" >
...
export default {
    ...
    methods:{
        login(){
            axios({
            url:'http://47.102.210.231:7117/api/login',
            params:{
